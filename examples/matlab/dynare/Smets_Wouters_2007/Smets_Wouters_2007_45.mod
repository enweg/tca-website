...
* model variables. Additionally, the rational expectations of inflation are 
...
/*
* Modifications were made from here on.
*/
...
stoch_simul(order = 1,irf=20) dy dc dinve labobs pinfobs dw robs piexp;
