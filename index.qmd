...
<div id="container-landingpage" class="columns-6">
    ...
    <section id="intro-text" class="columns-4 columns-6-all">
        ...
        <div class="columns-4-right">
            ...
            <ul class="list-horizontal">
                ...
                <li><a target="_blank" href="./examples/matlab/dynare/index.html">Examples</a></li>
    ...
    <section id="software" class="columns-6">
        <div id="software-intro" class="columns-6-long">
            ...
            <ul class="list-horizontal">
                <li><a target="_blank" href="./documentation/julia/index.qmd" class="btn bg-blue">Documentation</a></li>
                <li><a target="_blank" href="./examples/matlab/dynare/index.html">Examples</a></li>
            </ul>
        </div>
    ...
    <section id="example" class="columns-4 columns-6-all">
        ...
        <div class="columns-4-right">
            ...
            <p>
                <a target="_blank" href="./examples/matlab/dynare/index.html" class="btn bg-blue">Examples</a>
            </p>
        </div>
    </section>
